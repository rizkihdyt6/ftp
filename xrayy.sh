...
wget -q -O log-create "${REPO}log/loh-create.sh"
wget -q -O log-vmess "${REPO}log/loh-vmess.sh"
wget -q -O log-vless "${REPO}log/loh-vless.sh"
wget -q -O log-trojan "${REPO}log/loh-trojan.sh"
wget -q -O log-ss "${REPO}log/loh-ss.sh"
wget -q -O log-ss2022 "${REPO}log/loh-ss2022.sh"
wget -q -O log-socks "${REPO}log/loh-socks.sh"
wget -q -O log-allxray "${REPO}log/loh-allxray.sh"
sleep 0.5
